...
namespace YoutubeExplode.Tests
{
    ...
    public class YoutubeClientIntegrationTests
    {
        ...
        {
            var videoInfo = await _client.GetVideoInfoAsync("9bZkp7q19f0", false, false);
            Assert.IsTrue(videoInfo.NeedsDeciphering);

            await _client.DecipherStreamsAsync(videoInfo);
        ...
        public async Task GetFileSizeAsync_Normal_Test()
        {
            ...
            await _client.GetFileSizeAsync(streamInfo);
